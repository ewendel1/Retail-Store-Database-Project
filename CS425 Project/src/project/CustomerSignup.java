...
public class CustomerSignup extends JFrame {
	...
	public CustomerSignup() {
			...
			public void actionPerformed(ActionEvent e) {			
				try {
		            ...
		            synchronized( this ) {
			           ...
			           st.executeUpdate("INSERT INTO CUSTOMERS (CUSTOMERID, NAME, EMAIL, AGE, SEX, PHONENUMBER, PASSWORD) VALUES ('"+myId+"', '"+name.getText() +"', '"+email.getText()+"', '"
		            		+Integer.parseInt(age.getText())+"', '"+sex.getText()+"', '"+Integer.parseInt(phoneNumber.getText())+"', '"+password.getText()+"')");
			           st.executeUpdate("INSERT INTO PAYMENT (CUSTOMERID) VALUES ('"+myId+"')");
			           st.executeUpdate("INSERT INTO ADDRESS (CUSTOMERID) VALUES ('"+myId+"')");
			           st.close();
		            }
	            	conn.close();
		...
		btnNewButton.setBounds(125, 302, 101, 29);
